...
<template>
  ...
  <template v-else>
    <div class="stats-row">
      <div class="stat"><div class="stat-icon green">&#128101;</div><div class="stat-val">{{ totalPatients }}</div><div class="stat-label">Patients actifs</div></div>
      <div class="stat"><div class="stat-icon blue">&#128197;</div><div class="stat-val">{{ todayCount }}</div><div class="stat-label">RDV aujourd'hui</div></div>
      <div class="stat"><div class="stat-icon amber">&#128200;</div><div class="stat-val">{{ retention }}%</div><div class="stat-label">Retention</div></div>
      <div class="stat"><div class="stat-icon red">&#9888;</div><div class="stat-val">{{ lostCount }}</div><div class="stat-label">Perdus de vue</div></div>
    </div>
